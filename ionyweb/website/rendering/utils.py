...
def render_view(template_name, params={}, medias=(), context_instance=None, is_admin_view=False, title=None, http_headers={}, global_context={}):
    """
    ...
    return HTMLRendering(content, rendering_medias, title=title, http_headers=http_headers, global_context=global_context)
