...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field activities on 'Entry'
        m2m_table_name = db.shorten_name('page_blog_entry_activities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['page_blog.entry'], null=False)),
            ('activitynomenclature', models.ForeignKey(orm['coop_local.activitynomenclature'], null=False))
        ))
        db.create_unique(m2m_table_name, ['entry_id', 'activitynomenclature_id'])

        # Adding M2M table for field themes on 'Entry'
        m2m_table_name = db.shorten_name('page_blog_entry_themes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['page_blog.entry'], null=False)),
            ('transversetheme', models.ForeignKey(orm['coop_local.transversetheme'], null=False))
        ))
        db.create_unique(m2m_table_name, ['entry_id', 'transversetheme_id'])


    def backwards(self, orm):
        # Removing M2M table for field activities on 'Entry'
        db.delete_table(db.shorten_name('page_blog_entry_activities'))

        # Removing M2M table for field themes on 'Entry'
        db.delete_table(db.shorten_name('page_blog_entry_themes'))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'pXaSvfuRnUhjihvFCXdbFB'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'k9PY2PvZH9RSvRFechkpAV'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'HMhxpzJhn8gmTBte6gqQSR'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'JNUuuHC3VG6984nEqgDCSS'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'rMuKYrrWpvFAYxcj3Es34V'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'page_blog.entry': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 30, 0, 0)', 'db_index': 'True'}),
            ...
            'themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.TransverseTheme']", 'null': 'True', 'blank': 'True'}),
            'thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '200', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
