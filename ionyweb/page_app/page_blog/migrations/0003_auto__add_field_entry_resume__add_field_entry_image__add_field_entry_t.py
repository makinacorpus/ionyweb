...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.resume'
        db.add_column('page_blog_entry', 'resume',
    ...
    models = {
        ...
        'page_blog.entry': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 0, 0)', 'db_index': 'True'}),
