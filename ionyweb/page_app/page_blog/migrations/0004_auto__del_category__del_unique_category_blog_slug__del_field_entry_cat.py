...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('page_blog_entry', 'category_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('page_blog_category', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['page_blog.Category'], blank=True)),
        ...
        # User chose to not deal with backwards NULL issues for 'Entry.category'
        raise RuntimeError("Cannot reverse this migration. 'Entry.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Entry.category'
        db.add_column('page_blog_entry', 'category',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='entries', to=orm['page_blog.Category']),
                      keep_default=False)
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'FAsba6k6JbqrtfyTNcMmeD'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Yi4jhLcq45bZsU43k87jUf'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vK7he4HPJ53MrFaxd2G9Ni'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'R67fSC2FVzihkP7tTbg7RT'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'CQ2nwKChcvVXwH7PSFra4W'", 'max_length': '50', 'null': 'True'})
        },
