...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Contact.address'
        db.add_column('plugin_contact_plugin_contact', 'address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Contact.tel'
        db.add_column('plugin_contact_plugin_contact', 'tel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Contact.fax'
        db.add_column('plugin_contact_plugin_contact', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Contact.opening'
        db.add_column('plugin_contact_plugin_contact', 'opening',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_Contact.address'
        db.delete_column('plugin_contact_plugin_contact', 'address')

        # Deleting field 'Plugin_Contact.tel'
        db.delete_column('plugin_contact_plugin_contact', 'tel')

        # Deleting field 'Plugin_Contact.fax'
        db.delete_column('plugin_contact_plugin_contact', 'fax')

        # Deleting field 'Plugin_Contact.opening'
        db.delete_column('plugin_contact_plugin_contact', 'opening')
    ...
    models = {
        ...
        'plugin_contact.plugin_contact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opening': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'tel': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
